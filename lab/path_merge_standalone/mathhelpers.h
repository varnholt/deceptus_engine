...
inline bool comparePoints(const PointF& point_a, const PointF& point_b)
{
...
inline PointF normalize(const PointF& vector)
{
...
inline double coordByAxis(const PointF& point, int axis)
{
