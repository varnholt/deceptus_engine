...
public:
   ...
   /// \brief draws the layer sprite with explicit render states (used in WASM to carry the level view).
   /// \param target render target.
   /// \param normal normal-map render target (unused).
   /// \param states render states to apply; overridden by the parallax view when configured.
