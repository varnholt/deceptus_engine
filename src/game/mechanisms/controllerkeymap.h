...
static constexpr std::array<IconCell, 14> switch_large_map{{
   {"bt_a",     0, 12}, {"bt_b",     1, 12}, {"bt_x",     2, 12}, {"bt_y",     3, 12}, {"dpad_u",   4, 12},
   {"dpad_d",   5, 12}, {"dpad_l",   6, 12}, {"dpad_r",   7, 12}, {"bt_list",  8, 12}, {"bt_menu",  9, 12},
...
static constexpr std::array<IconCell, 10> switch_small_map{{
   {"bt_a",     0, 18}, {"bt_b",     1, 18}, {"bt_x",     2, 18}, {"bt_y",     3, 18}, {"bt_list",  4, 18},
   {"bt_menu",  5, 18}, {"bt_rt",    6, 18}, {"bt_lt",    7, 18}, {"bt_rb",    8, 18}, {"bt_lb",    9, 18},
}};
...
static constexpr std::array<IconCell, 10> playstation_small_map{{
   {"bt_a",     0, 20}, {"bt_b",     1, 20}, {"bt_x",     2, 20}, {"bt_y",     3, 20}, {"bt_menu",  4, 20},
   {"bt_list",  5, 20}, {"bt_rb",    6, 20}, {"bt_lb",    7, 20}, {"bt_rt",    8, 20}, {"bt_lt",    9, 20},
}};
...
static constexpr std::array<IconCell, 15> steam_deck_small_map{{
   {"bt_a",             0, 21}, {"bt_b",             1, 21}, {"bt_x",             2, 21}, {"bt_y",             3, 21}, {"bt_quick_access",  4, 21},
   {"bt_list",          5, 21}, {"bt_menu",          6, 21}, {"bt_rb",            7, 21}, {"bt_lb",            8, 21}, {"bt_rt",            9, 21},
   {"bt_lt",           10, 21}, {"bt_r4",           11, 21}, {"bt_l4",           12, 21}, {"bt_r5",           13, 21}, {"bt_l5",           14, 21},
}};
// clang-format on
