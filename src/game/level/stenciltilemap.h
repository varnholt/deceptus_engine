...
public:
   ...
   /// \brief loads base tilemap data and reads stencil_reference layer property.
   /// \param layer source TMX layer.
   /// \param tileset source TMX tileset.
   /// \param base_path base path used to resolve texture assets.
...
private:
   /// \brief writes a debug composite image that visualizes color output and stencil mask.
   /// \param color color render target.
   /// \param states render states forwarded to helper draw calls.
