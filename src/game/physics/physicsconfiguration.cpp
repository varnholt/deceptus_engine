...
void PhysicsConfiguration::deserialize(const std::string& data)
{
   ...
   _player_wall_jump_multiplier_increment_per_frame =
      config["PhysicsConfiguration"]["player_wall_jump_multiplier_increment_per_frame"].get<float>();
   _player_wall_jump_multiplier_scale_per_frame =
      config["PhysicsConfiguration"]["player_wall_jump_multiplier_scale_per_frame"].get<float>();
   _player_wall_jump_extra_force = config["PhysicsConfiguration"]["player_wall_jump_extra_force"].get<float>();
   _player_wall_jump_lock_key_duration_ms = config["PhysicsConfiguration"]["player_wall_jump_lock_key_duration_ms"].get<int32_t>();
   ...
   _player_hard_landing_delay_s = config["PhysicsConfiguration"]["player_hard_landing_delay_s"].get<float>();

   _player_in_water_force_jump_button = config["PhysicsConfiguration"]["player_in_water_force_jump_button"].get<float>();
   _player_in_water_time_to_allow_jump_button_ms =
      config["PhysicsConfiguration"]["player_in_water_time_to_allow_jump_button_ms"].get<int32_t>();
   _player_in_water_linear_velocity_y_clamp_min =
      config["PhysicsConfiguration"]["player_in_water_linear_velocity_y_clamp_min"].get<float>();
   _player_in_water_linear_velocity_y_clamp_max =
      config["PhysicsConfiguration"]["player_in_water_linear_velocity_y_clamp_max"].get<float>();
