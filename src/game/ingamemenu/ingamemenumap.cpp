...
void IngameMenuMap::updateLabels()
{
   ...
   InGameMenuLabels::updateFooterLabels({
      {._layer_plain = _layers["navigate_xbox_0"],
       ._layer_pressed = _layers["navigate_xbox_1"],
       ._icon_width_px = icon_width_navigate_xbox_px,
       ._text = "Navigate"},
      {._layer_plain = _layers["zoom_xbox_0"],
       ._layer_pressed = _layers["zoom_xbox_1"],
       ._icon_width_px = icon_width_zoom_xbox_px,
       ._text = "Zoom"},
      {._layer_plain = _layers["world_xbox_0"],
       ._layer_pressed = _layers["world_xbox_1"],
       ._icon_width_px = icon_width_world_xbox_px,
       ._text = "World Map"},
      {._layer_plain = _layers["legend_xbox_0"],
       ._layer_pressed = _layers["legend_xbox_1"],
   ...
   InGameMenuLabels::updateFooterLabels({
      {._layer_plain = _layers["navigate_pc_0"],
       ._layer_pressed = _layers["navigate_pc_1"],
       ._icon_width_px = icon_width_navigate_pc_px,
       ._text = "Navigate"},
      {._layer_plain = _layers["zoom_pc_0"],
       ._layer_pressed = _layers["zoom_pc_1"],
       ._icon_width_px = icon_width_zoom_pc_px,
       ._text = "Zoom"},
      {._layer_plain = _layers["world_pc_0"],
       ._layer_pressed = _layers["world_pc_1"],
       ._icon_width_px = icon_width_world_pc_px,
       ._text = "World Map"},
      {._layer_plain = _layers["legend_pc_0"],
       ._layer_pressed = _layers["legend_pc_1"],
