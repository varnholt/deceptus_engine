...
function updateState()
   ...
   -- TODO: RESET THE ANIMATION FRAME TO 0 WHEN THE STATE CHANGES
...
function updateSprite(dt)
   ...
   -- WHEN ATTACKING, THE TONGUE ANIMATION MUST BE PLAYED AND THE DISTANCE MUST BE ALIGNED WITH
   -- THE DISTANCE TO THE PLAYER, SO THE TONGUE MOVES OUT QUICKLY WHEN THE PLAYER IS IN REACH
   -- AFTER THE ATTACK, THE FROG CANNOT ATTACK FOR A CONFIGURABLE DELAY TIME
...
function smashed()
   ...
   -- TODO: LOOK UP REFERENCE IMPLEMENTATION FROM BLOB_2
   startDying()
end
